...
def get_median(total_entries,new_data):
    if total_entries%2==0:
        median1=float(new_data[total_entries//2])
        median2=float(new_data[total_entries//2-1])
        median=(median1+median2)/2
    else:
        median=float(new_data[total_entries//2])
...
get_median(total_entries,new_data)
get_mode(new_data)